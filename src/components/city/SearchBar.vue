<template>
  <div class="search-page--search-bar">
    <button class="search-page--search-bar--btn" type="button" @click="CancelBtnClick">
      <i class="hue-base-icon-base">✗</i>
    </button>
    <label class="header-search-box">
      <i class="hue-base-icon-base search-box--icon">Ƣ</i>
      <input ref="inputEl" class="search-box--input" type="text" @input="queryWord" placeholder="位置／关键词">
    </label>
  </div>
</template>
<script>
