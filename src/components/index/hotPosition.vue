<template>
  <div class="j_hotJobsList">
    ...
    <span class="inex_ExpandAll" @click="expandAll">{{isExpandAll ? "收起" : "展开全部"}}<i
      :class="isExpandAll ? 'h' : ''"></i></span>
  </div>
...
<style>
  ...
  .j_hotJobsList .warp.h {
    height: auto;
  }

  .j_hotJobsList .warp .list {
    overflow: hidden;
    border-bottom: 1px solid #e6e6e6;
  }

  .j_hotJobsList .warp .list dt {
    background-color: #fff;
    overflow: hidden;
    position: relative;
  }

  .j_hotJobsList .warp .list dt .wrap {
    width: 100%;
  ...
  .j_hotJobsList .warp .list dt span {
    float: left;
    color: #000;
    width: 25%;
    overflow: hidden;
  ...
  .j_hotJobsList .warp .list dt a:link, .j_hotJobsList .warp .list dt a:visited {
    color: #686868;
  }

  .j_hotJobsList .warp .list dd {
    background-color: #eaeaea;
    overflow: hidden;
    padding: 0 5px;
  }

  .j_hotJobsList .warp .list dd a {
    color: #646464;
    float: left;
    width: 25%;
    overflow: hidden;
  ...
  .j_hotJobsList .warp .list dd a:link, .j_hotJobsList .warp .list dd a:visited {
    color: #686868;
  }

  .j_hotJobsList .warp .list dt b {
    float: right;
    width: 40px;
    height: 48px;
  ...
  .j_hotJobsList .warp .list dt b.h {
  ...
  .inex_ExpandAll i {
    width: 6px;
    height: 8px;
    background: url("//img09.zhaopin.cn/2012/other/mobile/m/V52_screen_icon3.png") center center no-repeat;
